...
/* a list of prefixes affected by event with quagga prefix structure  */
struct event_affected_prefix_list{
    struct prefix * prefix_struct;
    bool processed_value;
    struct event_affected_prefix_list * next;
};
...
struct time_stamp_ds{
    ...
    struct event_affected_prefix_list *event_affected_prefix_list_value;

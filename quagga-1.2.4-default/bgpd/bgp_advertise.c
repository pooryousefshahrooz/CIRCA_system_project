...
zlog_debug ("*************Adding new advertisement to advertisement attribute list ***********\n");
		 ...
		 struct bgp_info *binfo)
{
  ...
  zlog_debug ("*************Add new advertisement to advertisement attribute list ***********\n");
		   ...
		   afi_t afi, safi_t safi)
{
  ...
  zlog_debug ("*************  in bgp_adj_out_unset ***********\n");
...
bgp_adj_in_set (struct bgp_node *rn, struct peer *peer, struct attr *attr)
{
  ...
  zlog_debug ("***************************** in bgp_adj_in_set for %s *****************************",peer->host);
